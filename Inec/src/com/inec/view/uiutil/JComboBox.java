 ...
 */
//@formatter:on
public class JComboBox extends MaterialWidget implements HasId, HasGrid, HasColors, HasValueChangeHandlers<String>, HasPlaceholder {

    public final ListBox listBox = new ListBox();
    public final Label lblName = new Label();
