...
public class AESencrypt {
	...
	public static String encrypt(String data) throws UnknownException{
		try{
        ...
        return stringBuffer.toString();
			...
			throw new UnknownException("Error al encriptar");
		}
	}
	
	public static String decrypt(String encryptedData) throws UnknownException{
		try{
		SecretKeySpec key = generarKey();
        Cipher c = Cipher.getInstance(ALGORITMO);
        ...
        return decryptedValue;
			...
			throw new UnknownException("Error al desencriptar");
		}
    }
}