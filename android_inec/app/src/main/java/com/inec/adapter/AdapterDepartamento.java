 ...
 */
public class AdapterDepartamento extends BaseAdapter {
    ...
    public AdapterDepartamento(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.ui_combo_departamento, null);
        TextView txtNomUbigeo=(TextView) convertView.findViewById(R.id.txt_partido);
        txtNomUbigeo.setText(bean.getDepartamento());
        return convertView;
    }
