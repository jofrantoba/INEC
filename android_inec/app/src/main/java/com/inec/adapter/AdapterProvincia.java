 ...
 */
public class AdapterProvincia extends BaseAdapter {
    ...
    public AdapterProvincia(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(R.layout.ui_combo_provincia, null);
        TextView txtNomUbigeo=(TextView) convertView.findViewById(R.id.txt_partido);
        txtNomUbigeo.setText(bean.getProvincia());
        return convertView;
    }
